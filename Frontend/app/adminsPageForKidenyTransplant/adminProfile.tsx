...
export default function map() {
  ...
  async function kidneyAdminProfile() {

    try {
      const token = await AsyncStorage.getItem('token');
      const response = await axios.post(`${baseUrl}/kidneyAdminProfile`, { token });
    ...
    <View style={style.box}>
      <ImageBackground
        ...
        <View style={style.box1}>
          <TouchableOpacity style={style.headerIcons} onPress={kidneyAdminProfile}>
