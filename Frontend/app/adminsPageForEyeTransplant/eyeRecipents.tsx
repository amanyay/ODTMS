...
export default function eyeDonor() {
    ...
    async function getEyeRecipent() {
        ...
        try {
            ...
            const response = await axios.get(`${baseUrl}/eyeBankRecipentAdmin`);
    ...
    return (
        ...
        >
            ...
            <View style={style.box2}>
                ...
                <TouchableOpacity style={style.box2Btn} onPress={getEyeRecipent}>
                    ...
                    <View style={style.organBox}>
                        ...
                        <View style={style.organBox1}>
                            ...
                            <View style={style.boxHeaderText}>
                                <Text style={style.boxHeaderText1}>Information about eye recipents</Text>
