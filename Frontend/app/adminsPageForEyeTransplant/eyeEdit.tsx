...
export default function organs() {
  ...
  async function getOrgansdata() {
    try {
      ...
      const request = await axios.post(`${baseUrl}/eyeBankOrganAdmin`, { token });
          ...
          <View style={style.organBox}>
            ...
            <ScrollView style={{ flex: 1 }}>
              <View style={style.organBoxText}>
                ...
                <Text style={style.organBoxText1}>Active Organ </Text><Text style={style.datas}>{item.organ_amount}</Text>
              </View>
            </ScrollView>
