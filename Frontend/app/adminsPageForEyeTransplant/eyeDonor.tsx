...
export default function eyeDonor() {
  ...
  async function getEyeDonors() {

    try {

      const response = await axios.get(`${baseUrl}/eyeBankDonorAdmin`);
  ...
  return (
    ...
    >
      ...
      <View style={style.box2}>
        ...
        <TouchableOpacity style={style.box2Btn} onPress={getEyeDonors}>
