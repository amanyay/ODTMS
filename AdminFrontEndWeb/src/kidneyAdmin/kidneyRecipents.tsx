...
import style from '../styles/kidneyCSS/kidneyRecipents.module.css'
...
export default function KidneyRecipents() {
  ...
  async function KidneyRecipentsInfo() {

    try {


      const request = await axios.post(`${baseUrl}/KidneyRecipentAdmin`)
  ...
  return (
    <div className={style.KidneyRecipentsMainBox}>
      <KidneyDrawerNavigation />
      <div className={style.KidneyRecipentsInfoBox}>
        <div className={style.section1}>
          <h3>Kidney Recipents</h3>
          <div>
