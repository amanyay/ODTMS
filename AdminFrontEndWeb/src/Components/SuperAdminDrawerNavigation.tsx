    ...
    return (
        <div className="drawerNavBox">
            ...
            <div className={style.SuperAdmindrawerNavBoxLinks}>
                ...
                <div className='links' ><li><NavLink className='aLogo' to={'/SuperAdminEdit'}><BiUser color='white' /></NavLink></li> <p><NavLink className='a' to={'/SuperAdminEdit'}>Admins</NavLink></p> </div>
                <div className='links' ><li><NavLink className='aLogo' to={'/SuperAdminHistory'}><RiHistoryLine color='white' /> </NavLink></li><p><NavLink className='a' to={'/SuperAdminHistory'}>History</NavLink></p> </div >
                <div className='links' ><li><NavLink className='aLogo' to={'/SuperAdminSearch'}><CiSearch color='white' /></NavLink></li><p><NavLink className='a' to={'/SuperAdminSearch'}>Search</NavLink></p> </div >
            </div >
