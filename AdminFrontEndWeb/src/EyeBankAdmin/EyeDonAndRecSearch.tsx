...
import style from '../styles/EyeBankCss/EyeDonAndRecSearch.module.css'
...
export default function eyeDonAndRecSearch() {
    ...
    async function search() {
        ...
        try {
            const request = await axios.post(`${baseUrl}/search`, { searchInput })
